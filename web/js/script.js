(function($) {
  //fonction pour afficher l'alert apres la researvation
 $('#alertreseravtion').hide() 
 $( "#formreservation" ).submit(function() {
  $('#alertreseravtion').show().fadeOut(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999)
});
