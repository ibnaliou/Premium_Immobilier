 ...
 */
class Client extends \PI\Premium_ImmobilierBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Client' . "\0" . 'numPiece', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Client' . "\0" . 'nomComplet', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Client' . "\0" . 'tel', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Client' . "\0" . 'adresse', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Client' . "\0" . 'email'];
        }
