 ...
 */
class Paiement extends \PI\Premium_ImmobilierBundle\Entity\Paiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Paiement' . "\0" . 'id', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Paiement' . "\0" . 'datePaiement', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Paiement' . "\0" . 'montant', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Paiement' . "\0" . 'periode', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Paiement' . "\0" . 'contrat'];
        }
