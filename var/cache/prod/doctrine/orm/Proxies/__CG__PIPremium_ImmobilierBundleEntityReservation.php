 ...
 */
class Reservation extends \PI\Premium_ImmobilierBundle\Entity\Reservation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Reservation' . "\0" . 'id', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Reservation' . "\0" . 'dateReservation', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Reservation' . "\0" . 'etat', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Reservation' . "\0" . 'bien', '' . "\0" . 'PI\\Premium_ImmobilierBundle\\Entity\\Reservation' . "\0" . 'client'];
        }
